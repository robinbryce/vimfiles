...
" Python: 4 spaces
" C: tab (8 spaces)
au BufRead,BufNewFile *.py,*.pyw,*pyx set shiftwidth=4

" Number of spaces that a pre-existing tab is equal to.
" For the amount of space used for a new tab use shiftwidth.
" Python: 8
" C: 8
au BufRead,BufNewFile *.py,*.pyw*,*.pyx set tabstop=8
...
au BufRead,BufNewFile *.py,*.pyx,*.pyx match BadWhitespace /^\t\+/

" Wrap text after a certain number of characters
" Python: 79 
" C: 79
au BufRead,BufNewFile *.py,*.pyx set textwidth=79
...
" Python: yes
" C: yes
au BufNewFile *.py,*.pyx set fileformat=unix
